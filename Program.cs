...
namespace LMA
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                y_dat.Add(GaussianNoise(ty_dat.ElementAt(i), 5));
            }
            ...
            Annealing.SimulatedAnnealing(lm_MSE(lm_f, t, y_dat), ref p_init, p_min, p_max, 1000, 0);
            ...
            Console.Read();
            LevenbergMarquardt.lm(lm_f, ref p_init, t, y_dat, p_min, p_max, 1000, 0,0,0,0,5,11,9);
